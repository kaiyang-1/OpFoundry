...
#define DSA_V32_COMBINE_INSTANTIATIONS                                                      \
    template __global__ void mla_combine_kernel<a8w8_traits_t,         dsa_v32_a8w8_kargs>(dsa_v32_a8w8_kargs);      \
    template __global__ void mla_combine_kernel<a16w16_16mx4_traits_t, dsa_v32_a16w16_kargs>(dsa_v32_a16w16_kargs);  \
    template __global__ void mla_combine_kernel<a16w16_32mx1_traits_t, dsa_v32_a16w16_kargs>(dsa_v32_a16w16_kargs);

#ifndef __HIP_DEVICE_COMPILE__
template<typename Traits, typename KArgs, int HEADS_PER_BLOCK = 8> __global__ void mla_combine_kernel(KArgs kargs) {}
DSA_V32_COMBINE_INSTANTIATIONS
#else
