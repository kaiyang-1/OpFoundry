// PA prefill attention D=512 fp8 kernel instantiation (16mx8_32nx1 variant)
...
template __global__ void pa_prefill_16mx8_32nx1_fp8_kernel<pa_16mx8_32nx1_fp8_traits<16, 32, 640, 8, fp8_t, bf16_t, bf16_t>>(pa_fp8_kargs);
#else
