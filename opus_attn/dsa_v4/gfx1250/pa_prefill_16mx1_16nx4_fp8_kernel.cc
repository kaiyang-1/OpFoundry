// PA prefill attention D=512 MXFP8 kernel instantiation (gfx1250 16mx1_16nx4_fp8 variant)
...
template __global__ void pa_prefill_16mx1_16nx4_fp8_kernel<pa_16mx1_16nx4_fp8_traits<16, 64, 4, fp8_t, bf16_t, bf16_t>>(pa_fp8_kargs);
